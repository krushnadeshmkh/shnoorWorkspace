...
import { FiFileText, FiEdit, FiTrash2, FiEdit2, FiSend, FiSave, FiMinus, FiX, FiMaximize2, FiPaperclip, FiBold, FiItalic, FiUnderline, FiAlignLeft, FiAlignCenter, FiAlignRight, FiList, FiChevronLeft, FiChevronRight, FiSearch } from 'react-icons/fi';
...
const EmployeeDrafts = () => {
  ...
  const getTitle = () => {
    if (editingDraftId) return 'Edit draft';
    return 'New draft';
  };
            ...
            <div className="flex flex-wrap items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                <button
                  ...
                  aria-label={showSearch ? 'Close search' : 'Search drafts'}
                >
              ...
              <div className={`${isMaximized ? 'flex-1' : ''}`} onContextMenu={handleContextMenu}>
                <Suspense fallback={<div className="h-48 flex items-center justify-center">Loading editor...</div>}>
                  <ReactQuill
                    ...
                    className={`quill-gmail ${isMaximized ? 'h-full' : 'h-48'}`}
                  />
                </Suspense>
              </div>
