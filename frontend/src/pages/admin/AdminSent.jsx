...
import { FiSend, FiPaperclip, FiChevronLeft, FiChevronRight, FiSearch } from 'react-icons/fi';
...
const AdminSent = () => {
  ...
  return (
    <AdminLayout>
      <div className="bg-white rounded-xl shadow-card overflow-hidden flex flex-col" style={{ height: 'calc(100vh - 120px)' }}>
